...
public class _330_BookManager {

        Scanner scan = new Scanner(System.in);

        HashMap<String, _330_Book> book_dic = new HashMap<String, _330_Book>();
        ...
        void addBook(){
               ...
               _330_Book book = new _330_Book(isbn,title,price);
        ...
        void searchBook(){
               ...
               if(book_dic.containsKey(isbn)){
                       ...
                       _330_Book book = book_dic.get(isbn);
        ...
        void listBook(){
               ...
               for(_330_Book book : book_dic.values()){
